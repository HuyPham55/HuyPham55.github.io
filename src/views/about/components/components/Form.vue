  ...
  <div class="form--container">
    ...
    <form ref="form" :action="formData.action" method="POST" target="hidden_frame">
      ...
      <div class="button--container">
        <button class="bg-gray-400 bg-opacity-50 text-black shadow-md dark:bg-black dark:bg-opacity-50 dark:text-gray-400 transition hover:bg-gray-200 hover:text-black dark:hover:bg-gray-400 p-4 rounded-xl" type="button" @click="hideModal">
          {{ formData.labels.buttons.cancel[lang] }}
        </button>
        <button class="bg-gray-400 bg-opacity-50 text-black shadow-md dark:bg-black dark:bg-opacity-50 dark:text-gray-400 transition hover:bg-gray-200 hover:text-black dark:hover:bg-gray-400 p-4 rounded-xl md:mx-4" type="button" @click="sessionHide">
