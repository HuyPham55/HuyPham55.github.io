...
<template>
  <div>
    <div class="about--container">
      ...
      <article class="md:w-2/3 p-4">
          ...
          <div class="mt-4">
            <div class="flex flex-col md:grid grid-cols-9 mx-auto lg:p-2">
              <div v-for="(item, index) in timeline"
                   ...
                   :key="item.title">
                <!-- left -->
                <div class="col-start-1 bg-gray-400 bg-opacity-50 text-black shadow-md dark:bg-black dark:bg-opacity-50 dark:text-gray-400 transition hover:bg-gray-200 hover:text-black dark:hover:bg-gray-400 p-4 rounded-xl col-end-5 my-4 cursor-pointer"
                     v-if="!(index%2)"
                ...
                <div
                    v-if="index%2"
                    class="bg-gray-400 bg-opacity-50 text-black shadow-md dark:bg-black dark:bg-opacity-50 dark:text-gray-400 transition hover:bg-gray-200 hover:text-black dark:hover:bg-gray-400 p-4 rounded-xl col-start-6 col-end-10 my-4 cursor-pointer"
                    @mouseover="hoverHandler(item, true)"
                    @mouseleave="hoverHandler(item, false)">
                  <h3 :class="{'font-semibold text-base mb-1':1, 'underline':item.hover }">
                    {{ item.title }}
        ...
        <section class="py-4">
          ...
          <div class="lg:p-2">
            <div
                class="bg-gray-400 bg-opacity-50 text-black shadow-md dark:bg-black dark:bg-opacity-50 dark:text-gray-400 transition hover:bg-gray-200 hover:text-black dark:hover:bg-gray-400 p-4 rounded-xl flex flex-row-reverse items-center justify-end mt-4">
              <h3 class="">
        ...
        <section class="py-4" v-if="experiences.length">
          ...
          <div class="lg:p-2">
            <div class="bg-gray-400 bg-opacity-50 text-black shadow-md dark:bg-black dark:bg-opacity-50 dark:text-gray-400 transition hover:bg-gray-200 hover:text-black dark:hover:bg-gray-400 p-4 rounded-xl mt-4 flex justify-around flex-wrap">
    ...
    <section class="about--container justify-evenly">
      ...
      <div class="mt-4 mx-4 md:mr-0 flex-grow transition md:w-0">
        <div class="cursor-pointer flex items-center bg-gray-400 bg-opacity-50 text-black shadow-md dark:bg-black dark:bg-opacity-50 dark:text-gray-400 transition hover:bg-gray-200 hover:text-black dark:hover:bg-gray-400 p-4 rounded-xl rounded-lg">
